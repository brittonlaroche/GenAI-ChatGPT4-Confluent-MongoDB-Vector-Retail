...
async function showThinking() {
  ...
  talkVideo.srcObject = undefined;
  if(pick > 50) {
    talkVideo.src = 'femdroid_thinking_short1.mp4';
  } else {
    talkVideo.src = 'femdroid_thinking_short2.mp4';
  }
  //talkVideo.src = 'femdroid_thinking_long.mp4';
  talkVideo.loop = false;
}
